...
+(void)showLoadingWithView:(UIView *)view andText:(NSString *)text{
...
+ (void)showAnimationImageView:(UIView *)view {
    if (view == nil) view = [UIApplication sharedApplication].keyWindow;
    // 快速显示一个提示信息
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:view animated:YES];
    // 设置图片
    UIImageView *imageView=[[UIImageView alloc]init];;
    imageView.center=[[[UIApplication sharedApplication] delegate] window].center;
    imageView.frame=CGRectMake((SCX_ScreenWidth-100)/2, (SCX_ScreenHeight-100)/2, 100, 100);
    //VoiceSearchIcon
    imageView.animationImages=@[[UIImage imageNamed:@"VoiceSearchIcon"],
                                [UIImage imageNamed:@"VoiceSearchIconHL"],[UIImage imageNamed:@"VoiceSearchStartBtn"]];
