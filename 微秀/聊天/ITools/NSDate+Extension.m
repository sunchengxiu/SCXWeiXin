...
- (BOOL)isThisWeek
{
    ...
    return nowCmps.weekday == selfCmps.weekday;
}
/**
 *  是否为上周
 */
- (BOOL)isThisYesWeek
{
    ...
    return nowCmps.weekday - selfCmps.weekday==1;
}
/**
 *  是否为本月
 */
...
- (BOOL)isThisYesMonth
{
    ...
    return nowCmps.month - selfCmps.month==1;
}
...
- (BOOL)isLastestThisYear
{
    ...
    return nowCmps.year - selfCmps.year>1;
}
